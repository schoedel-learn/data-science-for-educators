...
description: "What leaders should investigate next."
---
...
- District- and school-level assessment results to see beneath the state averages.
- Longitudinal, individual-student data to follow the same students over time (which NAEP cannot do).
- Contextual data on attendance, instructional time, and intervention programs.

## What interventions might be considered — carefully

Reading recovery programs, tutoring targeted at the students who fell furthest, and monitoring of grade 8 math readiness. These are suggestions to evaluate, not prescriptions — this project cannot say which interventions work.

## What questions should *not* be answered from this dataset alone

- **"What caused the decline?"** — NAEP data cannot answer this.
- **"Which individual students need help?"** — NAEP has no individual scores.
- **"Which schools are failing?"** — NAEP reports no school-level results.
