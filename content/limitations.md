---
type: page
title: "Correlations & Limitations"
description: "What this project can and cannot claim."
---
...
3. **What the data does not prove:** That COVID-19 — or school closures, or remote learning — *caused* the decline. The data document a change over time, not a cause.

4. **What would be needed to claim more:** Individual-student data following the same students over time, controls for the pre-existing downward trend, and comparison groups not exposed to the same disruption.

## Confounding factors

- **Pre-existing trends.** Reading was already drifting down before COVID (about −2 points from 2015 to 2019), so part of the post-COVID decline continues a trend that started earlier.
- **Compositional change.** NAEP tests a new sample of students each cycle, so shifts in who is tested can move the average without any student having learned less.
- **Broad social and economic disruption.** The pandemic coincided with many changes beyond schooling, so "the pandemic" is not one isolated cause.
